...
- 두번째 네트어크의 주 기능은 **anisotropic kernel**을 이용하여서 3D의 global structure 을 잡아 내는 것이다. ` Key to this network is the use of an elongated anisotropic kernel which helps capture the global structure of the 3D volume. `
