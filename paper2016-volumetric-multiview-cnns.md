...
- 이후 네트워크를 CNN1과 CNN2로 분Then we decompose the network to CNN1 (lower layers) and CNN2 (higher layers)to construct a multi-orientation version. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI3MjI5Nzk5N119
-->