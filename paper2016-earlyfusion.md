...
- 본 논문에서는 위 In this paper, we extend this method to learn multiple models, one for each 3-D pose,and evaluate both the original single model approach and themultimodel approach. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY3NTQ4ODY4XX0=
-->