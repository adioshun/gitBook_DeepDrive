...
- 향후 이미지와의 결합을 통ㅎFuture work includes extending VoxelNet for joint LiDAR and image based end-to-end 3D detection to further improve detection and localization accuracy
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NjQ0MDY1MTZdfQ==
-->