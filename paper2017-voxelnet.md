...
- In this paper, we remove the bottleneck of manual feature engineering and propose VoxelNet,a novel end-to-end trainable deep architecture forpoint cloud based 3D detection. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTgyNzk3NDU5XX0=
-->