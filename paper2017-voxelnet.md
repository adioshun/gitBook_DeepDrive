...
- 먼저 V에 있는 모든 포인트의 local mean을 구하여 Centroid값으로 정한다.  We first compute the local mean as the centroid of all the points in V, denoted as $(v_x, v_y, v_z)$.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMzOTg2NTk4N119
-->