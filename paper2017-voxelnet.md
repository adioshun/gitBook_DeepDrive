...
- 기존 방식은 수작업 특Most existing methods in LiDAR-based 3D detection rely on hand-crafted feature representations, for example,a bird’s eye view projection. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODUzMDkyNDYxXX0=
-->