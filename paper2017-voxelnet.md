...
- 합성곱 연산 : We use ConvMD($$c_{in}, c_{out}, k, s, p$$) to represent an M-dimensional convolution operator
	...
	- 각 합성곱 중간 레이어는 다음 절차를 순서대로 진행 한다. Each convolutional middle layer applies 3D convolution, BN layer, and ReLU layer sequentially. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjYzMTc4ODk3XX0=
-->