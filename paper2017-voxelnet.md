...
- 본 논문에서는 수작업 피쳐 엔지니어링을 제거한 VoxelNet를 제안 항In this paper, we remove the bottleneck of manual feature engineering and propose VoxelNet,
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjM2ODg0NTldfQ==
-->