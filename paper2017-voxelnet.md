...
- To retrieve the ground truth box from a matching positive anchor parameterized as $$(x^a_c, y^a_c, z^a_c, l^a, w^a, h^g, \theta^g)$$ 
), we define the
residual vector u
∗ ∈ R
7
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMjk1MzY1MTJdfQ==
-->