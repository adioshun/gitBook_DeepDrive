...
- 향후 이미지와의 결합을 통한 성능 향상을 진행 할 옞Future work includes extending VoxelNet for joint LiDAR and image based end-to-end 3D detection to further improve detection and localization accuracy
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3OTY5Nzk4ODFdfQ==
-->