...
- To retrieve the ground truth box from a matching positive anchor parameterized as $$(x^g_c, y^g_c, z^g_c, l^g, w^g, h^g, \theta^g)$$ 
), we define the
residual vector u
∗ ∈ R
7
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc0NTY5NjMyNl19
-->