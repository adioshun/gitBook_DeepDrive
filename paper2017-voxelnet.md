...
- 4000개의 학습 데이터는 오버 피팅 위험성이 있으므로 뎅With less than 4000 training point clouds, training our network from scratch will inevitably suffer from overfitting.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MzMzMjMyODFdfQ==
-->