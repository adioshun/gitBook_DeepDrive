...
- 이 샘플링의 목적은 다음과 같다. `This sampling strategy has two purposes,`
	- (1) computational savings (see Section 2.3 for details); and(2) decreases the imbalance of points between the voxelswhich reduces the sampling bias, and adds more variationto training.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMjQyMzg3MjBdfQ==
-->