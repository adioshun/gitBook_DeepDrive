...
- 각 합성곱 중간 레이어는 다음 절차를 순서대로 진행 한Each convolutional middle layer applies 3D convolution, BN layer, and ReLU layer sequentially. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MTYxMTM4MTldfQ==
-->