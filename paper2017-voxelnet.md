...
- 향후 이미지와의 결합을 통한 서Future work includes extending VoxelNet for joint LiDAR and image based end-to-end 3D detection to further improve detection and localization accuracy
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEyOTg5MjE2Ml19
-->