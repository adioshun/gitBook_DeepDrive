...
- In this work, we make several key modifications to the RPN architecture proposed in [32] ,and combine it with the feature learning network and convolutional middle layers to form an end-to-end trainablepipeline.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAyODEwMzc1Nl19
-->