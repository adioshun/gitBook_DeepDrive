...
- 실험 결과 성능이 좋다Our experiments on the KITTI car detection task show that VoxelNet outperformsstate-of-the-art LiDAR based 3D detection methodsby a large margin. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzU5NTU5NDE4XX0=
-->