...
| 코드 | [Chainer](https://github.com/yukitsuji/voxelnet_chainer), [TF](https://github.com/qianguih/voxelnet)-[Docker](https://github.com/aaalgo/awesome-dl-docker/blob/master/voxelnet/Dockerfile), [TF](https://github.com/jeasinema/VoxelNet-tensorflow), [pyTorch](https://github.com/traveller59/second.pytorch)+docker, [pytorch](https://github.com/skyhehe123/VoxelNet-pytorch), ~~[Docker(비번필요)](https://hub.docker.com/r/pyun/voxelnet)-[README](https://github.com/pyun-ram/FL3D/tree/master/VoxelNet)~~|
