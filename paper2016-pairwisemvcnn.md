...
- 하지만 However, this typically requires learning a generative model of the object and synthesising new views as an intermediate step. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUzNDkwMDI4NF19
-->