...
- For anchors that are not “responsible” for the detection, we penalize their confidence scores with the $\barI_{ijk} \gamma^2ijkterm, where ¯Iijk = 1 − Iijk. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM1OTUyNjU5XX0=
-->