...
- For anchors that are not “responsible” for the detection, we penalize their confidence scores with the $\barI_{ijk} \gamma^2_{ijkterm, where ¯Iijk = 1 − Iijk. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMzMxMDY3NzVdfQ==
-->