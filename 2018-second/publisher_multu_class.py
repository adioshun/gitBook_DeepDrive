...
car_lidar_file_paths = sorted(glob('/media/dongwonshin/Ubuntu Data/Datasets/KITTI/2011_10_03/2011_10_03_drive_0047_sync/velodyne_points/data/*.bin'))    
ped_lidar_file_paths = sorted(glob('/media/dongwonshin/Ubuntu Data/Datasets/KITTI/2011_09_28/2011_09_28_drive_0039_sync/velodyne_points/data/*.bin'))
res_lidar_file_paths = sorted(glob('/media/dongwonshin/Ubuntu Data/Datasets/KITTI/2011_09_30/2011_09_30_drive_0033_sync/velodyne_points/data/*.bin'))
