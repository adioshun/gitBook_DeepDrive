...
최근 3DRecent 3D deep learning architectures make use of occupancy grids as a representation for the input data to be learned or classified. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODg4NDE0NDA0XX0=
-->