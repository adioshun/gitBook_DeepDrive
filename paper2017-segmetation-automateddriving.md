...
- soft-max 분류기의 특징으로 인해 이전에 보지 못한Because the soft-max classifier is normalized to probability one, it doesn’t handle previous unseen objects. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MzE3MzcxNTVdfQ==
-->