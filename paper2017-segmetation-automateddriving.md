...
- 필셀기반 Pixel-wise Semantic segmentation produces regions of same object and hence does not provide individual objects in a segment. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMzgyMjA5NTVdfQ==
-->