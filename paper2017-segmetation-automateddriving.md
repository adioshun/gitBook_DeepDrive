...
- 해결 방안 : LThis could be achieved by customizing the loss function (eg: weighting ofimportant objects) but a modular end to end system will bescalable to automatically perform it.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDgwMzA1MTMwXX0=
-->