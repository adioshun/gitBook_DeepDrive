...
- 일반적으로 주행 환경에서의 화면은 A typical automotive scene has large complexity variability with simple structures like road or sky and complex structures like pedestrians. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMDkwMzgyMDBdfQ==
-->