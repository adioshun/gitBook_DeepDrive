...
- 딥러닝의 성공에는 이미지넷 데이터넷이 있다. 세그멘테이션으The real potential of deep learning was unveiled becauseof the large dataset Imagenet[46]. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE3NzE4Nzk3NF19
-->