...
- 위 그림은 차량에 설치된 4대의 카메라로 차량 주면을 36Figure 2 shows sample images ofthe four cameras mounted on the car. It covers the entire 360 field of view surrounding the car. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTQzNTIzMjBdfQ==
-->