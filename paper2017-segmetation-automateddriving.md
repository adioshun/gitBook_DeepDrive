...
- 하지만 fuse를 통해서 세그멘테이션시 깊이 정보를 제공 But it can provide a way to fuse semantic segmentation with depth information in a probabilistic framework. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4ODcxMTc4NDJdfQ==
-->