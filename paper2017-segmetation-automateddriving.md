...
- soft-max 분류기의 특징으Because the soft-max classifier is normalized to probability one, it doesn’t handle previous unseen objects. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc4MjM5OTg1OF19
-->