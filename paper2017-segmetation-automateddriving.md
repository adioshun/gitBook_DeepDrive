...
- 위 데이터로 학습한 모델은 다른 도시 환경이나 새로운 환경(턴The algorithms trained on this dataset do not generalize well to data tested on other cities and with unseen objects like tunnels.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjM3MTY3NTA3XX0=
-->