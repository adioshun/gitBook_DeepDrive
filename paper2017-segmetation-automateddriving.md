...
- 하지만 fuse를 통해서 But it can provide a way to fuse semantic segmentation with depth information in a probabilistic framework. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjYyNDYyNDM2XX0=
-->