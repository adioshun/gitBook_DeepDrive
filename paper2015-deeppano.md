...
또한 파노라마로 펼치게 되면 두개의 경계가 양쪽끝나타난다.  Moreover, unfolding the lateral surface creates two boundaries on the left and right sides of the panoramic view. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc0MTY1MDI2Nl19
-->